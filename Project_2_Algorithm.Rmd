...
## Overview
Least angle regression is a generalization of forward selection, where a regression model begins with an empty equation and adds variables one by one in order of predictive accuracy.
